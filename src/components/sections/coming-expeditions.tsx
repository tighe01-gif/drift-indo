...
const expeditions = [
  {
    ...
    description: "Volcanic landscapes, coastal roads and hidden surf breaks across three legendary islands.",
    image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800&q=80",
    duration: "10 Days",
  },
  {
    title: "Flores → Komodo Explorer",
    description: "Dragons, pink beaches and remote island routes through one of Indonesia's wildest regions.",
    image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&q=80",
    duration: "12 Days",
  },
  {
    title: "Sulawesi Discovery Route",
    description: "Jungle waterfalls, highland cultures and off-grid exploration through the heart of the archipelago.",
    image: "https://images.unsplash.com/photo-1518495973542-4542c06a5843?w=800&q=80",
    duration: "14 Days",
  },
  {
    title: "Raja Ampat Explorer",
    description: "Remote islands, crystal waters and absolute wilderness at the edge of the world.",
...
export function ComingExpeditionsSection() {
  return (
    <section id="expeditions" className="section-padding bg-volcanic relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {expeditions.map((expedition, i) => (
            <Reveal key={expedition.title} delay={i * 0.1}>
              <div className="group relative h-[420px] rounded-sm overflow-hidden">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-volcanic via-volcanic/50 to-volcanic/10" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <p className="text-off-white/60 text-sm leading-relaxed mb-5 max-w-md">
